...
import 'package:uts/screens/lupa_password.dart';
import 'package:uts/screens/pilihan.dart';
              ...
              children: [
                SingleChildScrollView(
                  child: Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: size.height * 0.015, left: 35),
                        child: Align(
                              ...
                              if (_emailkey.currentState!.validate()) {
                                if (_passwordKey.currentState!.validate()) {
                                  ...
                                  Future login() async{
                                    ...
                                    print(log);
                                    if(log == 1) {
                                      Navigator.push(context, MaterialPageRoute(builder: (_) => Pilihan(user: user!)));
                                      print(user);
                                    }else{
